import { c as createLucideIcon, i as getDefaultExportFromCjs, k as commonjsGlobal, r as reactExports, a as useAuth, u as useNavigate, d as ue, j as jsxRuntimeExports, S as Shield, B as Button, f as LoadingSpinner, b as Stethoscope, D as DoctorStatus } from "./index-1WRhTf4i.js";
import { S as StatusBadge } from "./StatusBadge-Bu-d5fRK.js";
import { I as Input } from "./input-OrHZ9evO.js";
import { u as useDoctorProfile } from "./useDoctorProfile-fX_xI_iv.js";
import { Q as QrCode } from "./qr-code-BfCRU2Mv.js";
import { T as TriangleAlert } from "./triangle-alert-DRjbu9A_.js";
import "./clock-BocBxEPW.js";
import "./circle-check-big-CiF-9UmZ.js";
...
function DoctorDashboardPage() {
  ...
  const [scanMode, setScanMode] = reactExports.useState(false);
  const {
    videoRef,
    canvasRef,
    isScanning,
  ...
  reactExports.useEffect(() => {
    if (qrResults.length > 0) {
      ...
      if (match) {
        ...
        ue.error("Invalid QR code — not a MedVault emergency code.");
      }
    }
  }, [qrResults, navigate, stopScanning]);
  if (!isAuthenticated) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-[calc(100vh-4rem)] flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
  ...
  if (isLoading)
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner, { size: "lg", label: "Loading doctor profile..." }) });
  if (!doctorProfile) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-lg mx-auto px-4 py-12 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold mb-2", children: "Doctor Registration Required" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-4", children: "Submit a registration request to access the doctor portal." }),
  ...
  if (doctorProfile.status !== DoctorStatus.approved) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-lg mx-auto px-4 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl border border-border p-8 text-center shadow-elevated", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { status: doctorProfile.status, className: "mb-4" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold mt-2", children: doctorProfile.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm mt-2", children: [
        doctorProfile.status === DoctorStatus.pending && "Your account is pending admin approval.",
        doctorProfile.status === DoctorStatus.rejected && `Rejected: ${doctorProfile.rejectionReason ?? "No reason provided"}`,
        doctorProfile.status === DoctorStatus.suspended && "Your account has been suspended."
      ] })
    ] }) });
  }
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl border border-border shadow-elevated overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary px-6 py-4 flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Stethoscope, { className: "w-5 h-5 text-primary-foreground" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-bold text-primary-foreground", children: "Doctor Portal" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { status: doctorProfile.status, className: "ml-auto" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-semibold text-lg text-foreground", children: doctorProfile.name }),
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-4 border-b border-border flex items-center justify-between", children: [
                ...
                isScanning && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-[oklch(0.55_0.15_142)] font-medium animate-pulse", children: "● Scanning..." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6", children: scanMode ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-foreground/5 rounded-xl overflow-hidden aspect-video", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "video",
                    {
                      ref: videoRef,
                  ...
                  !isScanning && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-48 h-48 border-2 border-primary/60 rounded-lg" }) })
                ] }),
                scanError && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-accent", children: scanError.message }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-24 rounded-2xl bg-primary/5 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(QrCode, { className: "w-12 h-12 text-primary/40" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl border border-border shadow-elevated p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-semibold text-foreground flex items-center gap-2 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "w-4 h-4 text-primary" }),
            "Manual Patient Search"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleManualSearch, className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "w-4 h-4 mr-1" }),
                  "Search"
                ]
              }
            )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 p-4 rounded-xl bg-accent/5 border border-accent/20", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Patient data access is logged and audited. Only access records for patients under your care." })
        ] })
      ]
    }
  );
